#!/usr/bin/env python3
"""
DMG creation and packaging module for EyeBrowserOS
...
def package(ctx: BuildContext) -> bool:
    ...
    if create_dmg(app_path, dmg_path, "EyeBrowserOS", pkg_dmg_path):
...
def package_universal(contexts: List[BuildContext]) -> bool:
    ...
    if create_dmg(universal_app_path, dmg_path, "EyeBrowserOS", pkg_dmg_path):
